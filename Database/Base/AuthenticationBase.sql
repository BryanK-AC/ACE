...
--
-- Host: localhost    Database: ace_auth_test
-- ------------------------------------------------------
...
--
-- Current Database: `ace_auth_test`
--

/*!40000 DROP DATABASE IF EXISTS `ace_auth_test`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ace_auth_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
/*
-- Query: SELECT * FROM ace_auth_test.accesslevel
